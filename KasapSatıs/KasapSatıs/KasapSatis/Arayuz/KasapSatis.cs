...
using KasapSatis.Arayuz;

namespace KasapSatis
{
    public partial class KasapSatis : Form
    {
        public KasapSatis()
        {
            InitializeComponent();
        ...
        EtMüsterileri mf = new EtMüsterileri();
        EtSatis uf = new EtSatis();
        ...
        {
            AracSatisForm frm = new AracSatisForm()
            {
                Text = "Satış Yap",
                Satis = new Satis()
                {
